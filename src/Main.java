public class Main {
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Задача 1", "Описание 1", 0, Status.NEW);
        Task task2 = new Task("Задача 2", "Описание 2", 0, Status.NEW);
        ...
        Epic epic2 = new Epic("Эпик 2", "Описание Эпика 2", 0, Status.NEW);
