...
public class Main {
    public static void main(String[] args) {
        ...
        historyManager.add(manager.getTaskById(task2.getId()));
        historyManager.add(manager.getEpicById(epic2.getId()));
        historyManager.add(manager.getSubtaskById(subtask3.getId()));
